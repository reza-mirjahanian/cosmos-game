...
func init() {
	proto.RegisterType((*MsgIncrementCounter)(nil), "alice.checkers.v1.MsgIncrementCounter")
	proto.RegisterType((*MsgIncrementCounterResponse)(nil), "alice.checkers.v1.MsgIncrementCounterResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "alice.checkers.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "alice.checkers.v1.MsgUpdateParamsResponse")
}
...
var fileDescriptor_d8e435dc85b9892e = []byte{
	...
	0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x22, 0x04, 0xbd, 0xdb, 0x37, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) IncrementCounter(ctx context.Context, in *MsgIncrementCounter, opts ...grpc.CallOption) (*MsgIncrementCounterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/alice.checkers.v1.Msg/IncrementCounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/alice.checkers.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_IncrementCounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.checkers.v1.Msg/IncrementCounter",
	}
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.checkers.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
