...
const (
	Query_Counter_FullMethodName  = "/alice.checkers.v1.Query/Counter"
	Query_Counters_FullMethodName = "/alice.checkers.v1.Query/Counters"
	Query_Params_FullMethodName   = "/alice.checkers.v1.Query/Params"
)
